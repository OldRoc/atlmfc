...
#ifdef _M_ARM64EC
// Disable optimizing this function for ARM64EC, as it casts a function pointer to several
// different signatures (undefined behaviour), and constant propagation of this function
// pointer's value associates multiple different call signatures with the same function,
// causing exit thunk generation to fail to operate correctly.
#pragma optimize("", off)
#endif
