...
IFileOpenDialog* CFileDialog::GetIFileOpenDialog() throw()
{
	ASSERT(m_bVistaStyle == TRUE);
...
IFileSaveDialog* CFileDialog::GetIFileSaveDialog() throw()
{
	ASSERT(m_bVistaStyle == TRUE);
...
IFileDialogCustomize* CFileDialog::GetIFileDialogCustomize() throw()
{
	ASSERT(m_bVistaStyle == TRUE);
...
void CFileDialog::AddPlace(LPCWSTR lpszFolder, FDAP fdap) throw()
{
	if (!m_bVistaStyle)
	{
		return;
...
void CFileDialog::AddPlace(IShellItem* psi, FDAP fdap) throw()
{
	if (!m_bVistaStyle)
	{
		return;
...
IShellItem *CFileDialog::GetResult() throw()
{
...
IShellItemArray *CFileDialog::GetResults() throw()
{
